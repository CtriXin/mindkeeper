...
export function parseProcedure(content) {
    const { meta, body } = parseFrontmatter(content);
    const procedureMeta = {
        name: String(meta.name || 'unnamed'),
        trigger: meta.trigger,
        description: meta.description ? String(meta.description) : undefined,
        defaultModel: meta.defaultModel || 'auto',
        tags: meta.tags,
    };
    // 按 ## 分割步骤
...
/** 加载 Procedure 文件 */
export function loadProcedure(name) {
...
/** 根据触发词查找 Procedure */
export function findProcedureByTrigger(trigger) {
...
/** 生成 Procedure 的执行计划 */
export function planExecution(procedure, context) {
...
/** 格式化步骤为可执行的 prompt */
export function formatStepPrompt(step, context) {
