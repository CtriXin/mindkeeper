...
export type SuggestionType =
  | 'continue_thread'    // 继续未完成的 thread
  | 'review_observation' // 回顾最近的观察
  | 'promote_belief'     // 将观察升级为信念
  | 'maintain_knowledge' // 维护过期知识
  | 'capture_signal'     // 采集新信号
  | 'run_procedure'      // 执行某个 procedure
  | 'rest';              // 没什么要做的
...
/** 读取文件内容摘要 */
function readSummary(path: string, maxLines: number = 10): string {
